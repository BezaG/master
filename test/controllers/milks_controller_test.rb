...
class MilksControllerTest < ActionController::TestCase
  ...
  test "should create milk" do
    assert_difference('Milk.count') do
      post :create, milk: { company: @milk.company, condition: @milk.condition, location: @milk.location, price: @milk.price, reciept: @milk.reciept, tel: @milk.tel, user: @milk.user }
    end
  ...
  test "should update milk" do
    patch :update, id: @milk, milk: { company: @milk.company, condition: @milk.condition, location: @milk.location, price: @milk.price, reciept: @milk.reciept, tel: @milk.tel, user: @milk.user }
    assert_redirected_to milk_path(assigns(:milk))
  end
