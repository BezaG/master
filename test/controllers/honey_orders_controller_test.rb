...
class HoneyOrdersControllerTest < ActionController::TestCase
  ...
  test "should create honey_order" do
    assert_difference('HoneyOrder.count') do
      post :create, honey_order: { amount: @honey_order.amount, company: @honey_order.company, price: @honey_order.price, tel: @honey_order.tel, user: @honey_order.user }
    end
  ...
  test "should update honey_order" do
    patch :update, id: @honey_order, honey_order: { amount: @honey_order.amount, company: @honey_order.company, price: @honey_order.price, tel: @honey_order.tel, user: @honey_order.user }
    assert_redirected_to honey_order_path(assigns(:honey_order))
  end
