...
class EggOrdersControllerTest < ActionController::TestCase
  ...
  test "should create egg_order" do
    assert_difference('EggOrder.count') do
      post :create, egg_order: { company: @egg_order.company, daily_quantity: @egg_order.daily_quantity, egg_id: @egg_order.egg_id, location: @egg_order.location, price: @egg_order.price, user_id: @egg_order.user_id }
    end
  ...
  test "should update egg_order" do
    patch :update, id: @egg_order, egg_order: { company: @egg_order.company, daily_quantity: @egg_order.daily_quantity, egg_id: @egg_order.egg_id, location: @egg_order.location, price: @egg_order.price, user_id: @egg_order.user_id }
    assert_redirected_to egg_order_path(assigns(:egg_order))
  end
