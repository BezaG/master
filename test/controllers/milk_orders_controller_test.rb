...
class MilkOrdersControllerTest < ActionController::TestCase
  ...
  test "should create milk_order" do
    assert_difference('MilkOrder.count') do
      post :create, milk_order: { company: @milk_order.company, location: @milk_order.location, milk_id: @milk_order.milk_id, price: @milk_order.price, tel: @milk_order.tel, user: @milk_order.user }
    end
  ...
  test "should update milk_order" do
    patch :update, id: @milk_order, milk_order: { company: @milk_order.company, location: @milk_order.location, milk_id: @milk_order.milk_id, price: @milk_order.price, tel: @milk_order.tel, user: @milk_order.user }
    assert_redirected_to milk_order_path(assigns(:milk_order))
  end
